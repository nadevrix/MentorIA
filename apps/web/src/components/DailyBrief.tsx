...
export default function DailyBrief() {
  ...
  return (
    <section className="rounded-xl border border-[var(--color-accent)]/40 bg-[var(--color-surface)] p-4">
      ...
      <p className="mt-2 min-h-[3rem] text-[15px] leading-relaxed text-slate-100">
